...
def plot_glauber_dynamics(results: str):
    ...
    plot.initialize_figure(
        ...
        y_label="Number of recolorings taken to reach proper coloring",
        title="Metropolis (or Glauber Dynamics) approach to coloring perfect graph",
        figsize=(10, 10)
    )

    # Now, plot the actual data
    plot_scatter_data_from_tuple_with_trial_labels(
        [chromatic_numbers, iterations_taken],
        ['Chromatic Number (k)', '# Recolorings']
